'''
    ...
    保存在"./Analysis/Data/seed_{}/{}".format(argv.seed,argv.datasetspan)目录下
'''
...
def extractData(sub_span, num, isTrain, ModelPath, targetDumpFolder_):
    ...
    if isTrain:
        ...
        train = "test"
    timeseries, labels, subjIds= Metric_abcdLoader(sub_span, train, 375)
...
if argv.train == "train":
    ...
    isTrain = False
ModelPath = "./Analysis/TargetSavedModels/foldCount_None/seed_{}/{}/model_epoch_{}.save".format(argv.seed,argv.datasetspan,argv.model_epoch)
print("ModelPath = {}".format(ModelPath))
targetDumpFolder = "./Analysis/Data/seed_{}/{}".format(argv.seed,argv.datasetspan)
